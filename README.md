...
### 🖼️ 3. Triển Lãm Ảnh Lịch Sử (Gallery)
...
### 🛠️ 5. Hệ Thống Quản Trị Admin
* Xác thực bảo mật JWT Token qua Interceptor.
* Trình soạn thảo văn bản phong phú (Rich Text Editor).
* Quản lý danh mục sách, bài viết nghiên cứu và tài khoản độc giả.
...
* **Lưu trữ Cloudflare R2:** 
  * Chi phí lưu trữ: **0 VNĐ (10 GB miễn phí vĩnh viễn)**.
  * Chi phí băng thông tải ra (Egress): **0 VNĐ không giới hạn**.
  * Không tốn bất kỳ dung lượng ổ cứng nào trên máy chủ Backend VPS.
...
| **Cloud Storage** | [Cloudflare R2 Object Storage](https://www.cloudflare.com/products/r2/) | S3-Compatible API |
...
```bash
tutuong-HCM/
├── public/                     # Tài nguyên tĩnh công khai (favicon, robots.txt)
├── src/
│   ├── assets/                 # Hình ảnh tư liệu, hoa văn trống đồng (bg3.jpg), âm thanh
│   ├── components/             # Các component dùng chung (Admin, Navbar, VisitorTracker...)

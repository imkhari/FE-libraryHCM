    ...
    return (
        <div className="min-h-screen bg-[#f4f7f6] flex font-sans text-slate-800">
            ...
            <button
                ...
                className="md:hidden fixed top-4 left-4 z-50 p-2.5 bg-white text-red-600 rounded-full shadow-md hover:bg-red-50 transition-colors border border-red-100"
            >
                <HiMenuAlt2 size={24} />
            </button>
      ...
      `}>
            ...
            <main className="flex-1 w-full min-w-0 flex flex-col h-screen overflow-hidden">
                ...
                {/* HEADER DESKTOP */}
                <header className="hidden md:flex h-20 shrink-0 items-center justify-end px-8 bg-white/60 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-30">
                    <div className="flex items-center gap-4 bg-white px-5 py-2 rounded-full border border-slate-200 shadow-sm cursor-pointer hover:shadow-md hover:border-red-200 transition-all group">
                        <div className="text-right">
                            {/* 🌟 ĐÃ FIX: Tự động hiển thị tên thật từ LocalStorage */}
                            <p className="text-sm font-bold text-slate-800 leading-tight group-hover:text-red-700 transition-colors">{adminName}</p>
                            {/* 🌟 ĐÃ FIX: Đổi Tag theo đúng quyền */}
                        ...
                        <div className="w-10 h-10 bg-gradient-to-tr from-red-600 to-red-500 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-inner ring-2 ring-red-100">
